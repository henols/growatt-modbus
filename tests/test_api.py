"""Tests for growatt_modbus api."""
import asyncio

import aiohttp
from homeassistant.helpers.aiohttp_client import async_get_clientsession

from custom_components.growatt_modbus.api import GrowattModbus
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = GrowattModbusApiClient("test", "test", async_get_clientsession(hass))
